...
### Example
To create `com.box.sdk.BoxDeveloperEditionAPIConnection` you will need to create a class that implements
`com.box.sdk.IAccessTokenCache`, for example we providing a simple memory cache solution `com.box.sdk.InMemoryLRUAccessTokenCache`:
```java
