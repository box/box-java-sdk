...
public class MetadataTemplateTest {
  ...
  public void testGetAllEnterpriseMetadataTemplatesSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(metadataTemplateURL))
    ...
    Iterator<MetadataTemplate> templates =
        MetadataTemplate.getEnterpriseMetadataTemplates(this.api).iterator();
  ...
  public void testSetOptionReturnsCorrectly() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(metadataTemplateURL))
    ...
    MetadataTemplate template =
        MetadataTemplate.createMetadataTemplate(
            this.api, "enterprise", "documentFlow03", "Document Flow 03", false, fields);
  ...
  public void testUpdateMetadataReturnsCorrectly() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(metadataTemplateURL))
    ...
    MetadataTemplate template =
        MetadataTemplate.updateMetadataTemplate(
            this.api, "enterprise", "documentFlow03", fieldOperations);
  ...
  public void testUpdateMetadataTemplateWithStaticConfigReturnsCorrectly() {
    final String metadataTemplateURL = "/2.0/metadata_templates/enterprise/documentFlow03/schema";
    String result =
        TestUtils.getFixture("BoxMetadataTemplate/UpdateMetadataTemplateWithStaticConfig200");
    ...
    assertEquals(
        "Top Seret",
        option.getStaticConfig().getClassification().getString("classificationDefinition", "null"));
  ...
  public void testExecuteMetadataQueryWithFields() {
    ...
    wireMockRule.stubFor(
        post(urlPathEqualTo(metadataQueryURL))
    ...
    MetadataQuery queryBody =
        new MetadataQuery(from, limit)
            .setQuery(query)
            .addParameter("arg", "Bob Dylan")
            .setAncestorFolderId(ancestorFolderId)
            .setFields(field1, field2, field3, field4);
    BoxResourceIterable<BoxItem.Info> results =
        MetadataTemplate.executeMetadataQuery(this.api, queryBody);
