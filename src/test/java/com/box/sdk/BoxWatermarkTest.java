...
public class BoxWatermarkTest {
  ...
  public void testCreateWatermarkOnFolderSucceedsSendsCorrectJson() {
    ...
    JsonObject innerObject = new JsonObject().add("imprint", "default");
    JsonObject watermarkObject = new JsonObject().add("watermark", innerObject);

    String result = TestUtils.getFixture("BoxWatermark/CreateWatermarkOnFolder200");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(watermarkURL))
  ...
  public void testGetWatermarkOnFolderSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(watermarkURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testDeleteWaterOnFolderSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteWatermarkURL))
            .willReturn(
  ...
  public void testCreateWatermarkOnFileSucceedsAndSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(fileWatermarkURL))
            .withRequestBody(WireMock.equalToJson(watermarkObject.toString()))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
