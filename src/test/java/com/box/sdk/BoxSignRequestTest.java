...
public class BoxSignRequestTest {
  ...
  public void createSignRequestSucceeds() {
    ...
    final String iframeableEmedUrl =
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo("/2.0/sign_requests"))
            .willReturn(
                WireMock.aResponse()
    ...
    BoxSignRequest.Info signRequestInfo =
        BoxSignRequest.createSignRequest(this.api, files, signers, parentFolderId, params);
  ...
  public void cancelSignRequestSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(requestUrl))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
