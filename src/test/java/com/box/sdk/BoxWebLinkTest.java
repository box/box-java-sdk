...
public class BoxWebLinkTest {
  ...
  public void testCreateWebLinkSucceedsAndSendsCorrectJson() throws IOException {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(webLinkURL))
            .willReturn(
                WireMock.aResponse()
  ...
  public void testGetWebLinkSucceeds() throws IOException {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(webLinkURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testUpdateWebLinkSucceedsAndSendsCorrectJson() throws IOException {
    ...
    JsonObject updatedObject = new JsonObject().add("name", newName).add("url", newURL);

    String result = TestUtils.getFixture("BoxWebLink/UpdateWebLinkOnFolder200");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(webLinkURL))
  ...
  public void createsASharedLink() {
    ...
    BoxSharedLinkWithoutPermissionsRequest sharedLinkRequest =
        new BoxSharedLinkWithoutPermissionsRequest()
            .access(OPEN)
