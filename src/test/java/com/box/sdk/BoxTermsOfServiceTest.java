...
public class BoxTermsOfServiceTest {
  ...
  public void testGetAllTermsOfServicesSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(tosURL))
            .willReturn(
                WireMock.aResponse()
    ...
    List<BoxTermsOfService.Info> termsOfServices =
        BoxTermsOfService.getAllTermsOfServices(this.api);
  ...
  public static class EnumValueCheckerTosType {
    ...
    public EnumValueCheckerTosType(
        String inputString, BoxTermsOfService.TermsOfServiceType expectedResult) {
    ...
    public void termsOfServiceTypeTest() {
      assertEquals(
          this.expectedResult, BoxTermsOfService.TermsOfServiceType.fromTosType(this.inputString));
    }
  }
  ...
  public static class EnumValueCheckerTosStatus {
    ...
    public EnumValueCheckerTosStatus(
        String inputString, BoxTermsOfService.TermsOfServiceStatus expectedResult) {
      this.inputString = inputString;
      this.expectedResult = expectedResult;
    }
    ...
    public void termsOfServiceStatusTest() {
      assertEquals(
          this.expectedResult, BoxTermsOfService.TermsOfServiceStatus.fromStatus(this.inputString));
    }
  }
}
