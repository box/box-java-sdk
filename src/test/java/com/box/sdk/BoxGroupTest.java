...
public class BoxGroupTest {
  ...
  public void testGetAllGroupsByNameSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(getGroupsByNameURL))
  ...
  public void testGetAllGroupsByNameWithFieldsOptionSucceeds() {
    ...
    Iterator<BoxGroup.Info> iterator =
        BoxGroup.getAllGroupsByName(this.api, "Test", "description").iterator();
    BoxGroup.Info firstGroupInfo = iterator.next();
  ...
  public void testGetMembershipForAUserSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(getMembershipForUserURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testGetMembershipForAGroupSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(getGroupMembershipURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testDeleteGroupMembershipSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteGroupMembershipURL))
            .willReturn(
  ...
  public void testUpdateGroupMembershipSucceeds() {
    ...
    JsonObject membershipObject = new JsonObject().add("role", "admin");

    String result = TestUtils.getFixture("BoxGroup/UpdateGroupMembership200");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(groupMembershipURL))
  ...
  public void testCreateGroupMembershipSucceedsAndSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(groupCollaborationURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testGetGroupsCollaborationsSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(groupCollaborationURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testGetAllGroupsCollaborationsSucceeds() {
    ...
    // First item on the second page of results (this next call makes the second request to get the
    // second page)
  ...
  public void testDeleteAGroupSucceedsAndSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteGroupURL))
            .willReturn(
                WireMock.aResponse().withHeader("Content-Type", APPLICATION_JSON).withStatus(204)));
  ...
  public void testUpdateAGroupInfoSendsCorrectJson() {
    ...
    JsonObject groupObject = new JsonObject().add("name", groupName);
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(groupURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(groupURL))
  ...
  public void testCreateGroupSucceedsAndSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(createGroupsURL))
            .withRequestBody(WireMock.equalToJson(groupObject.toString()))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
  ...
  public void testGetAllEnterpriseGroupsSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(getAllGroupsURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
