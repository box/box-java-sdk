...
public class BoxGroupTest {
	...
	public void testGetAllGroupsByNameSucceeds() throws IOException{
		...
		this.wireMockRule.stubFor(WireMock.get(WireMock.urlPathEqualTo(getGroupsByNameURL))
	...
	public void testGetMembershipForAUserSucceeds() throws IOException {
		...
		this.wireMockRule.stubFor(WireMock.get(WireMock.urlPathEqualTo(getMembershipForUserURL))
			.willReturn(WireMock.aResponse()
				.withHeader("Content-Type", "application/json")
				.withBody(result)));
	...
	public void testGetMembershipForAGroupSucceeds() throws IOException {
		...
		this.wireMockRule.stubFor(WireMock.get(WireMock.urlPathEqualTo(getGroupMembershipURL))
			.willReturn(WireMock.aResponse()
				.withHeader("Content-Type", "application/json")
				.withBody(result)));
	...
	public void testDeleteGroupMembershipSucceeds() {
		...
		this.wireMockRule.stubFor(WireMock.delete(WireMock.urlPathEqualTo(deleteGroupMembershipURL))
			.willReturn(WireMock.aResponse()
				.withHeader("Content-Type", "application/json")
				.withStatus(204)));
	...
	public void testUpdateGroupMembershipSucceeds() throws IOException {
		...
		this.wireMockRule.stubFor(WireMock.put(WireMock.urlPathEqualTo(groupMembershipURL))
	...
	public void testCreateGroupMembershipSucceedsAndSendsCorrectJson() throws IOException {
		...
		result = TestConfig.getFixture("BoxGroup/CreateGroupMembership200");

		this.wireMockRule.stubFor(WireMock.post(WireMock.urlPathEqualTo(groupCollaborationURL))
			.willReturn(WireMock.aResponse()
			  .withHeader("Content-Type", "application/json")
			  .withBody(result)));
	...
	public void testGetAllGroupsCollaborationsSucceeds() throws IOException {
		...
		this.wireMockRule.stubFor(WireMock.get(WireMock.urlPathEqualTo(groupCollaborationURL))
			.willReturn(WireMock.aResponse()
			  .withHeader("Content-Type", "application/json")
			  .withBody(result)));
	...
	public void testDeleteAGroupSucceedsAndSendsCorrectJson() throws IOException {
		...
		this.wireMockRule.stubFor(WireMock.delete(WireMock.urlPathEqualTo(deleteGroupURL))
			.willReturn(WireMock.aResponse()
			  .withHeader("Content-Type", "application/json")
			  .withStatus(204)));
	...
	public void testUpdateAGroupInfoSendsCorrectJson() throws IOException {
		...
		this.wireMockRule.stubFor(WireMock.get(WireMock.urlPathEqualTo(groupURL))
			.willReturn(WireMock.aResponse()
			  .withHeader("Content-Type", "application/json")
			  .withBody(getGroupResult)));

		this.wireMockRule.stubFor(WireMock.put(WireMock.urlPathEqualTo(groupURL))
	...
	public void testCreateGroupSucceedsAndSendsCorrectJson() throws IOException {
		...
		result = TestConfig.getFixture("BoxGroup/CreateAGroup200");

		this.wireMockRule.stubFor(WireMock.post(WireMock.urlPathEqualTo(createGroupsURL))
			.withRequestBody(WireMock.equalToJson(groupObject.toString()))
			.willReturn(WireMock.aResponse()
				  .withHeader("Content-Type", "application/json")
				  .withBody(result)));
    ...
    public void testGetAllEnterpriseGroupsSucceeds() throws IOException{
		...
		this.wireMockRule.stubFor(WireMock.get(WireMock.urlPathEqualTo(getAllGroupsURL))
			  .willReturn(WireMock.aResponse()
					  .withHeader("Content-Type", "application/json")
					  .withBody(result)));
	...
	public void testRestoreFileFromTrashSucceeds() throws IOException {
		...
		result = TestConfig.getFixture("BoxTrash/RestoreFileItemFromTrash200");
	...
	public void testRestoreFolderFromTrashSucceeds() throws IOException {
		...
		result = TestConfig.getFixture("BoxTrash/RestoreFolderItemFromTrash200");
