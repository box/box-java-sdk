...
public class BoxLegalHoldPolicyTest {
  ...
  public void testGetLegalHoldPolicySucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(legalHoldsURL))
            .willReturn(
                WireMock.aResponse()
  ...
  public void testCreateNewLegalHoldPolicySucceedsAndSendsCorrectJson() {
    ...
    JsonObject policyObject =
        new JsonObject().add("policy_name", policyName).add("is_ongoing", true);

    String result = TestUtils.getFixture("BoxLegalHold/PostOngoingLegalHoldPolicies201");

    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(legalHoldsURL))
  ...
  public void testCreateNewLegalHoldPolicyWithDateFilters() throws ParseException {
    ...
    BoxLegalHoldPolicy.Info policyInfo =
        BoxLegalHoldPolicy.create(this.api, policyName, null, startTime, endTime);
  ...
  public void testCreateOngoingNewLegalHoldPolicySucceedsAndSendsCorrectJson() {
    ...
    BoxLegalHoldPolicy.Info policyInfo =
        BoxLegalHoldPolicy.createOngoing(this.api, policyName, description);
  ...
  @Test
  public void testCreateOngoingWithStartDateNewLegalHoldPolicySucceedsAndSendsCorrectJson()
    ...
    String result =
        TestUtils.getFixture("BoxLegalHold/PostOngoingWithStartDateLegalHoldPolicies201");
    ...
    BoxLegalHoldPolicy.Info policyInfo =
        BoxLegalHoldPolicy.createOngoing(this.api, policyName, description, startTime);
  ...
  public void testUpdateLegalHoldPolicySucceedsAndSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(legalHoldsURL))
  ...
  public void testDeleteLegalHoldPolicySucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(legalHoldsURL))
            .willReturn(
