...
public class BoxWebHookSignatureVerifierTest {
  ...
  public void testInvalidVersion() {
    BoxWebHookSignatureVerifier verifier =
        new BoxWebHookSignatureVerifier(PRIMARY_SIGNATURE_KEY, SECONDARY_SIGNATURE_KEY);
    assertTrue(
        verifier.verify(
            SIGNATURE_VERSION,
            SIGNATURE_ALGORITHM,
  ...
  @Test
  public void verifyPrimaryKeyOnly() {
    final BoxWebHookSignatureVerifier verifier =
        new BoxWebHookSignatureVerifier(PRIMARY_SIGNATURE_KEY, null);

    assertFalse(
        verifier.verify(
            SIGNATURE_VERSION, SIGNATURE_ALGORITHM, "", "", WEB_HOOK_PAYLOAD, DELIVERY_TIMESTAMP));
    assertFalse(
        verifier.verify(
            SIGNATURE_VERSION,
            SIGNATURE_ALGORITHM,
