...
public class BoxTaskAssignmentTest {
  ...
  @Test
  public void testCreateTaskAssignmentOnUserSucceedsAndSendsCorrectJson() {
    ...
    JsonObject taskObject = new JsonObject().add("type", "task").add("id", policyID);

    JsonObject assignedToObject = new JsonObject().add("id", assignedToID);

    JsonObject assignmentObject =
        new JsonObject().add("task", taskObject).add("assign_to", assignedToObject);

    String result = TestUtils.getFixture("BoxTask/CreateTaskAssignment201");

    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(taskAssignmentURL))
  ...
  @Test
  public void testGetTaskAssignmentInfoByIDSucceeds() {
    final String assignmentID = "12345";
  ...
  @Test
  public void testSetTaskOnTaskAssignmentSucceeds() {
    final String assignmentID = "12345";
    final String assignmentURL = "/2.0/task_assignments/" + assignmentID;
    final String status = "incomplete";
    JsonObject taskObject = new JsonObject().add("status", status);
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(assignmentURL))
  ...
  @Test
  public void testGetTaskAssignmentsSucceeds() {
    final String policyID = "11111";
    final String assignmentID = "12345";
    final String fileID = "22222";
    final String assignedToID = "33333";
  ...
  @Test
  public void testGetAllTaskAssignmentsSucceeds() {
    final String policyID = "11111";
    final String assignmentID = "12345";
    final String fileID = "22222";
    final String assignmentURL = "/2.0/tasks/" + policyID + "/assignments";
  ...
  @Test
  public void testUpdateTaskAssignmentInfoSucceeds() {
    final String assignmentID = "12345";
    final String assignedToID = "33333";
    final String assignedToLogin = "testuser@example.com";
    final String updatedMessage = "Looks good to me!";
    final BoxTaskAssignment.ResolutionState updatedState =
        BoxTaskAssignment.ResolutionState.COMPLETED;
    final String assignmentURL = "/2.0/task_assignments/" + assignmentID;
