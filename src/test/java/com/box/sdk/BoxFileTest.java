...
public class BoxFileTest {
  ...
  public void testGetFileInfoSucceeds() throws ParseException {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(fileURL))
            .willReturn(
                WireMock.aResponse()
  ...
  public void testDeserializationException() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(filesURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testRemoveSharedLink() {
    final String fileID = "12345";
    final String fileURL = "/2.0/files/" + fileID;
    JsonObject jsonObject = new JsonObject().add("shared_link", (String) null);

    String putResult = getFixture("BoxFile/GetFileInfo200");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(fileURL))
  ...
  public void testGetTasksWithFields() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(tasksURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testUpdateFileInformationSucceedsAndSendsCorrectJson() {
    ...
    JsonObject updateObject = new JsonObject().add("name", newFileName);
  ...
  public void testCopyFileSucceedsAndSendsCorrectJson() {
    ...
    JsonObject innerObject = new JsonObject().add("id", "0");
  ...
  public void testMoveFileSucceedsAndSendsCorrectJson() {
    ...
    JsonObject moveObject = new JsonObject().add("id", newParentID);
    JsonObject parentObject = new JsonObject().add("parent", moveObject);
  ...
  public void testDeleteFileSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteFileURL))
            .willReturn(
  ...
  public void testLockFileSucceedsAndSendsCorrectJson() {
    ...
    JsonObject innerObject =
        new JsonObject().add("type", "lock").add("is_download_prevented", "true");
        ...
        WireMock.get(WireMock.urlPathEqualTo("/2.0/files/" + fileID))
            ...
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(
                        getFixture("BoxFile/GetFileRepresentations200", wireMockRule.httpsPort()))
                    .withStatus(200)));
    wireMockRule.stubFor(
        WireMock.get(
            ...
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(
                        getFixture("BoxFile/GetFileRepresentation200", wireMockRule.httpsPort()))
                    .withStatus(200)));
    wireMockRule.stubFor(
        WireMock.get(
                WireMock.urlPathEqualTo(
        ...
        WireMock.get(
            ...
            .willReturn(
                WireMock.aResponse()
                    ...
                    .withBody(
                        getFixture(
                            "BoxFile/GetFileRepresentation200WithPending",
  ...
  public void testDeletePreviousFileVersionSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(versionURL))
            .willReturn(
                WireMock.aResponse().withHeader("Content-Type", APPLICATION_JSON).withStatus(204)));
  ...
  public void testUploadNewVersionReturnsCorrectInfo() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo("/2.0/files/" + fileID + "/content"))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void createSharedLinkSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo("/2.0/files/" + fileID))
  ...
  public void createEditableSharedLinkSucceeds() {
    ...
    JsonObject permissionsObject =
        new JsonObject().add("can_download", true).add("can_preview", true).add("can_edit", true);
  ...
  public void testDownloadFromSharedLinkWithPassword() {
    ...
    final String expectedSharedLinkHeaderValue =
        "shared_link=" + sharedLink + "&shared_link_password=" + password;
    final String expectedDownloadPath = "/shared/static/rh935iit6ewrmw0unyul.jpeg";
    final String expectedDownloadUrl =
        format("https://localhost:%d%s", wireMockRule.httpsPort(), expectedDownloadPath);

    String sharedItemsResponse = "{ \"type\": \"file\", \"id\": \"12345\" }";

    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(sharedItemsURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(fileContentURL))
            .withHeader("boxapi", WireMock.equalTo(expectedSharedLinkHeaderValue))
            .willReturn(
                WireMock.aResponse().withStatus(302).withHeader("Location", expectedDownloadUrl)));

    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(expectedDownloadPath))
            .willReturn(
                WireMock.aResponse()
    ...
    verify(
        1,
        getRequestedFor(urlEqualTo("/2.0/shared_items?fields=id"))
            .withHeader("BoxApi", WireMock.equalTo(expectedSharedLinkHeaderValue)));

    verify(
        1,
        getRequestedFor(urlEqualTo(fileContentURL))
            .withHeader("boxapi", WireMock.equalTo(expectedSharedLinkHeaderValue)));
  ...
  public void testAddClassification() {
    ...
    final String metadataURL =
        "/2.0/files/" + fileID + "/metadata/enterprise/securityClassification-6VMVochwUWo";
  ...
  public void testSetMetadataReturnsCorrectly() {
    ...
    JsonObject firstAttribute =
        new JsonObject().add("op", "add").add("path", "/test1").add("value", firstValue);
  ...
  @Test
  public void testChunkedVersionUploadWithCorrectPartSizeAndAttributes()
    ...
    JsonObject sessionObject = new JsonObject().add("file_size", 5);
  ...
  public void setsVanityUrlOnASharedLink() {
    ...
    BoxSharedLinkRequest sharedLink = new BoxSharedLinkRequest().vanityName("myCustomName");
