...
public class BoxAPIResponseTest {
  ...
  public void testJsonResponseToString() {
    ...
    ByteArrayInputStream responseBody =
        new ByteArrayInputStream("{\"foo\":\"bar\"}".getBytes(UTF_8));
    BoxAPIResponse response =
        new BoxAPIResponse(
            202,
            "GET",
  ...
  public void testBoxJSONResponseToString() {
    ...
    BoxAPIResponse response = new BoxJSONResponse(202, "GET", "https://aaa.com", headers, jsonBody);
  ...
  public void testLargeBinaryResponseContentLength() {
    ...
    BoxAPIResponse response =
        new BoxAPIResponse(202, "GET", "https://aaa.com", headers, inputStream, "image/jpg", -1);
