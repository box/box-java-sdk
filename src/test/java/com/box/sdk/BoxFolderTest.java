...
public class BoxFolderTest {
  ...
  public void testChunkedUploadThrows409() throws IOException, InterruptedException {
    ...
    JsonObject preflightObject =
        new JsonObject().add("name", "testfile.txt").add("size", 5).add("parent", idObject);

    wireMockRule.stubFor(
        WireMock.options(WireMock.urlPathEqualTo(preflightURL))
  ...
  @Test
  public void testChunkedUploadWithCorrectPartSizeAndAttributes()
    ...
    String sessionResult =
        TestUtils.getFixture("BoxFile/CreateUploadSession201", wireMockRule.httpsPort());
    ...
    JsonObject partOne =
        new JsonObject().add("part_id", "CFEB5BA9").add("offset", 0).add("size", 5);
    ...
    JsonObject commitObject =
        new JsonObject().add("parts", parts).add("attributes", fileAttributesJson);
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(sessionURL))
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(uploadURL))
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(commitURL))
  ...
  @Test
  public void testChunkedParallelUploadWithCorrectPartSizeAndAttributes()
      throws IOException, InterruptedException {
    String javaVersion = System.getProperty("java.version");
    Assume.assumeFalse("Test is not run for JDK 7", javaVersion.contains("1.7"));
    final String preflightURL = "/2.0/files/content";
    ...
    BoxFile.Info uploadedFile =
        folder.uploadLargeFile(stream, "testfile.txt", 5, 2, 60, TimeUnit.SECONDS, fileAttributes);
  ...
  public void testChunkedUploadWith500Error() throws IOException, InterruptedException {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(listPartsURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
  ...
  public void testGetAllRootFolderItemsSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(rootFolderItemsURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withStatus(200)
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(folderURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(info)
  ...
  public void testGetFolderInfoSucceeds() {
    ...
    final String classificationDefinition =
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(folderInfoURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testSetRestrictedCollaborationFieldSucceeds() {
    final String folderID = "12345";
    final String folderInfoURL = "/2.0/folders/" + folderID;
    JsonObject jsonObject = new JsonObject().add("is_collaboration_restricted_to_enterprise", true);
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(folderInfoURL))
  ...
  public void testUpdateFolderInfoSucceedsAndSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(folderURL))
  ...
  public void testCreateNewFolderSucceedsAndSendsCorrectJson() {
    ...
    JsonObject parentObject = new JsonObject().add("id", "0");

    JsonObject createFolderObject =
        new JsonObject().add("name", folderName).add("parent", parentObject);

    String result = TestUtils.getFixture("BoxFolder/CreateNewFolder201");

    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(folderURL))
  ...
  public void testCopyFolderSucceedsAndSendsCorrectJson() {
    ...
    JsonObject parentObject = new JsonObject().add("id", newParentID);

    JsonObject copyObject = new JsonObject().add("parent", parentObject);
  ...
  public void testMoveFolderSucceedsAndSendsCorrectJson() {
    ...
    JsonObject innerObject = new JsonObject().add("id", parentID);

    JsonObject parentObject = new JsonObject().add("parent", innerObject);

    String result = TestUtils.getFixture("BoxFolder/MoveFolder200");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(moveFolderURL))
  ...
  public void testDeleteFolderSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteFolderURL))
  ...
  public void testCreateSharedLinkForFolderSucceedsAndSendsCorrectJson() {
    ...
    JsonObject accessObject = new JsonObject().add("access", "open");

    JsonObject sharedLinkObject = new JsonObject().add("shared_link", accessObject);
  ...
  public void testGetAllFolderCollaborationsSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(folderCollaborationURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
    ...
    assertEquals(
        BoxCollaborator.CollaboratorType.GROUP, collaborationInfo2.getAccessibleBy().getType());
    assertEquals(
        BoxCollaborator.GroupType.MANAGED_GROUP,
  ...
  public void testGetAllFolderCollaborationsWithFieldsSucceeds() {
    final String folderID = "3333";
    final String folderCollaborationURL =
        "/2.0/folders/" + folderID + "/collaborations?fields=id%2Ctype%2Ccan_view_path";

    String result = TestUtils.getFixture("BoxFolder/GetAllFolderCollaborations200WithFields");

    wireMockRule.stubFor(
        WireMock.get(WireMock.urlEqualTo(folderCollaborationURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
    ...
    Collection<BoxCollaboration.Info> collaborations =
        folder.getCollaborations("id", "type", "can_view_path");
  ...
  public void testCreateMetadataOnFolderSucceedsAndSendsCorrectJson() {
    ...
    JsonObject metadataObject = new JsonObject().add("foo", "bar");

    String result = TestUtils.getFixture("BoxFolder/CreateMetadataOnFolder201");

    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(metadataURL))
  ...
  public void testGetMetadataOnFolderSucceds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(metadataURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testAddMetadataCascadePolicySucceedsSendsCorrectJson() {
    ...
    BoxMetadataCascadePolicy.Info metadataCascadePolicyInfo =
        folder.addMetadataCascadePolicy(scope, templateKey);
  ...
  public void testGetAllMetadataCascadePoliciesOnFolderSucceeds() {
    ...
    Iterator<BoxMetadataCascadePolicy.Info> metadataCascadePolicies =
        folder.getMetadataCascadePolicies().iterator();
  ...
  public void testGetAllMetadataCascadePoliciesOnFolderWithFieldsSucceeds() {
    ...
    BoxFolder folder = new BoxFolder(this.api, folderID);
    Iterator<BoxMetadataCascadePolicy.Info> metadataCascadePolicies =
        folder.getMetadataCascadePolicies("owner_enterprise").iterator();
  ...
  public void testGetAllMetadataCascadePoliciesWithEnterpriseIDSucceeds() {
    ...
    BoxFolder folder = new BoxFolder(this.api, folderID);
    Iterator<BoxMetadataCascadePolicy.Info> metadataCascadePolicies =
        folder.getMetadataCascadePolicies(enterpriseID, limit, "owner_enterprise").iterator();
  ...
  public void createSharedLinkSucceeds() {
    ...
    JsonObject permissionsObject =
        new JsonObject().add("can_download", true).add("can_preview", true).add("can_edit", false);
    ...
    JsonObject sharedLinkObject = new JsonObject().add("shared_link", innerObject);

    String result = TestUtils.getFixture("BoxSharedLink/CreateSharedLink201");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo("/2.0/folders/" + folderID))
            .withRequestBody(WireMock.equalToJson(sharedLinkObject.toString()))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
    ...
    BoxSharedLink sharedLink =
        folder.createSharedLink(
            new BoxSharedLinkRequest().access(OPEN).permissions(true, true).password(password));
  ...
  public void createSharedLinkChangesCanEditPermissionToFalse() {
    ...
    JsonObject sharedLinkJson =
        new JsonObject()
            .add("password", password)
            .add("access", "open")
            .add("permissions", permissionsObject);

    JsonObject sharedLinkObject = new JsonObject().add("shared_link", sharedLinkJson);
    ...
    BoxFolder folder = new BoxFolder(this.api, folderID);
    folder.createSharedLink(
        new BoxSharedLinkRequest().access(OPEN).permissions(true, true, true).password(password));
  }
  ...
  public void testAddClassification() {
    ...
    final String metadataURL =
        "/2.0/folders/" + folderID + "/metadata/enterprise/securityClassification-6VMVochwUWo";
    JsonObject metadataObject =
        new JsonObject().add("Box__Security__Classification__Key", classificationType);
  ...
  public void testUpdateClassification() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(metadataURL))
  ...
  public void testSetClassification() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(metadataURL))
            .willReturn(WireMock.aResponse().withBody("{}").withStatus(409)));
  ...
  public void testSetClassificationThrowsException() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(metadataURL))
            .willReturn(WireMock.aResponse().withBody("{}").withStatus(403)));
  ...
  public void testDeleteClassification() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(metadataURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON_PATCH)
                    .withStatus(204)));
  ...
  public void testUploadFileWithCorrectMultipartOrder() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(fileURL))
            .withRequestBody(
                WireMock.matching(
                    ".*attributes.*file.*")) // Check that attributes comes before file
  ...
  public void testGetFolderItemsWithSortAndOffset() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(folderItemsURL))
    ...
    BoxFolder folder = new BoxFolder(this.api, "12345");
    Iterator<BoxItem.Info> itemIterator =
        folder.getChildren("name", BoxFolder.SortDirection.ASC, "name").iterator();
  ...
  public void testGetFolderItemsWithOffsetAndLimit() {
    ...
    BoxFolder folder = new BoxFolder(this.api, "12345");
    Iterator<BoxItem.Info> itemIterator =
        folder.getChildren("name", BoxFolder.SortDirection.ASC, 10, 500, "name").iterator();
    BoxItem.Info boxItem1 = itemIterator.next();
    assertEquals("Test", boxItem1.getName());
    BoxItem.Info boxItem2 = itemIterator.next();
    assertEquals("Test 2", boxItem2.getName());
  ...
  public void testSetMetadataReturnsCorrectly() {
    ...
    JsonObject firstAttribute =
        new JsonObject().add("op", "add").add("path", "/test1").add("value", "text");

    JsonObject secondAttribute =
        new JsonObject().add("op", "add").add("path", "/test2").add("value", secondValueJson);

    JsonObject thirdAttribute =
        new JsonObject().add("op", "add").add("path", "/test3").add("value", thirdValue);

    JsonObject fourthAttribute =
        new JsonObject().add("op", "add").add("path", "/test4").add("value", fourthValue);
  ...
  public void testDeserializationException() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(foldersURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void createFolderLockSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(folderLockURL))
  ...
  public void getFolderLocks() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(folderLocksURL))
            .withQueryParam("folder_id", WireMock.equalTo(folderID))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
  ...
  public void deleteFolderLockSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteFolderLockURL))
            .willReturn(
                WireMock.aResponse().withHeader("Content-Type", APPLICATION_JSON).withStatus(204)));
  ...
  public void setsVanityUrlOnASharedLink() {
    ...
    BoxSharedLinkRequest request = new BoxSharedLinkRequest().vanityName("myCustomName");
  ...
  public void startIteratingWithMarker() {
    ...
    BoxFolder folder = new BoxFolder(this.api, "123456");
    assertFalse(folder.getChildren(SortParameters.none(), marker(2)).iterator().hasNext());
  }
    ...
    api.setRequestInterceptor(
        new JSONRequestInterceptor() {
          ...
          public BoxJSONResponse onJSONRequest(BoxJSONRequest request, JsonObject body) {
            assertEquals(
                "https://api.box.com/2.0/collaborations?notify=true", request.getUrl().toString());
            ...
            assertEquals(
                collaboratorLogin, body.get("accessible_by").asObject().get("login").asString());
