...
public class BoxTrashTest {
  ...
  public void testGetAllTrashedItemsSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(trashURL))
  ...
  public void testRestoreFolderFromTrashSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(restoreFolderURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testRestoreFileFromTrashSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(restoreFileURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testGetAllTrashedItemsWithOrderAndOffsetAndLimit() {
    ...
    BoxTrash trash = new BoxTrash(this.api);
    Iterable<BoxItem.Info> trashEntries =
        trash.items(SortParameters.descending("name"), PagingParameters.offset(100, 500));
  ...
  public void testGetAllTrashedItemsWithStreamPositionAndLimit() {
    ...
    BoxTrash trash = new BoxTrash(this.api);
    Iterable<BoxItem.Info> trashEntries =
        trash.items(SortParameters.none(), PagingParameters.marker(500));
  ...
  public void testGetAllTrashedItemsFailsWithOrderAndStreamPosition() {
    ...
    assertThrows(
        ...
        () -> trash.items(SortParameters.ascending("name"), PagingParameters.marker(500)));
  }
}
