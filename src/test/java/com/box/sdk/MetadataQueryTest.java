...
public class MetadataQueryTest {
  ...
  public void createsMetadataQuery() {
    MetadataQuery query =
        new MetadataQuery("from somewhere", 100)
            .setQuery("some query")
  ...
  public void canSetParametersOnQuery() {
    MetadataQuery query =
        new MetadataQuery("from somewhere", 100)
            .setQueryParams(new JsonObject().add("stringParam", "some value"));
  ...
  public void canSetOrderByAsJsonArray() {
    MetadataQuery query =
        new MetadataQuery("from somewhere", 100)
            .setOrderBy(
                new JsonArray()
                    .add(new JsonObject().add("field_key", "field").add("direction", "desc")));
