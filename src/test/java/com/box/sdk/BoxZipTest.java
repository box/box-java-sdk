...
public class BoxZipTest {
	...
	public void createAndDownloadZipSucceeds() throws IOException {
		...
		// File bytes for zips will not always be equal since they are being generated by every test. To approximate that the files are equal
		// the assertion below checks the lengths
