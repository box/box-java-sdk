...
public class BoxCollaborationTest {
  ...
  public void testCreateFileCollaborationSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(collaborationURL))
    ...
    BoxCollaboration.Info collabInfo =
        file.collaborate(collaborator, BoxCollaboration.Role.EDITOR, false, false, expiresAt, true);
  ...
  public void testAcceptPendingCollaborationSendsCorrectJson() {
    ...
    JsonObject acceptInvite = new JsonObject().add("status", "accepted");
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(collaborationURL))
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(acceptCollaborationURL))
    ...
    Collection<BoxCollaboration.Info> pendingCollaborations =
        BoxCollaboration.getPendingCollaborations(this.api);
  ...
  public void testGetPendingCollaborationInfoWithFieldsSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlEqualTo(collaborationURL))
            .withQueryParam("status", WireMock.containing("pending"))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
  ...
  public void testGetCollaborationsOnFolderSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(getFolderCollaborationURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testDeletedCollaborationSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteCollaborationURL))
            .willReturn(
  ...
  public void testCreateAndEditCollaborationSucceeds() {
    ...
    Date expiresAt = new Date(1586289090000L);
    JsonObject user = new JsonObject().add("id", "2222").add("type", "user");
    JsonObject folder = new JsonObject().add("id", "5678").add("type", "folder");
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(createCollaborationURL))
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(editCollaborationURL))
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(editCollaborationURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(editResult)));
    ...
    BoxCollaboration.Info collabInfo =
        BoxCollaboration.create(
            this.api, user, folder, BoxCollaboration.Role.EDITOR, false, false, expiresAt, false);
  ...
  public void testGetCollaborationInfoSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(getCollaborationURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testCanViewPathSendsCorrectJson() {
    ...
    JsonObject jsonObject = new JsonObject().add("can_view_path", true).add("role", "editor");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(collaborationURL))
  ...
  public void testGetInviteEmailSucceeds() {
    ...
    String result =
        TestUtils.getFixture("BoxCollaboration/GetInviteEmailAttributesOnCollaboration200");
    ...
    BoxCollaboration.Info collabInfo =
        new BoxCollaboration(this.api, collabID).getInfo("invite_email");
