...
public class BoxUserTest {
  ...
  public void testGetAvatar() throws IOException {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(expectedURL))
            .willReturn(
                WireMock.aResponse()
                    .withStatus(200)
  ...
  private void getCurrentUserTest() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(userURL))
            .willReturn(WireMock.okForContentType(APPLICATION_JSON, result)));

    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(userInfoURL))
            .willReturn(WireMock.okForContentType(APPLICATION_JSON, result)));
  ...
  public void testCreateAppUserSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(userURL))
            .willReturn(WireMock.okForContentType(APPLICATION_JSON, result)));
  ...
  public void testCreateManagedUserSucceedsWithFields() {
    ...
    BoxUser.Info createdUserInfo =
        BoxUser.createEnterpriseUser(this.api, userLogin, userName, "name", "login", "timezone");
  ...
  public void testUpdateUserInfoSucceedsAndSendsCorrectJson() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(userURL))
  ...
  public void testDeleteUserWithParamsSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(userURL))
  ...
  public void testCreateEmailAliasSucceeds() {
    ...
    JsonObject emailAliasObject = new JsonObject().add("email", emailAlias);

    String result = TestUtils.getFixture("BoxUser/CreateEmailAlias201");

    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(emailAliasURL))
  ...
  public void testGetEmailAliasSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(emailAliasURL))
            .willReturn(WireMock.okForContentType(APPLICATION_JSON, result)));
  ...
  public void testDeleteEmailAliasSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(deleteAliasURL)).willReturn(WireMock.noContent()));
  ...
  public void testGetAllEnterpriseUsersSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(getAllUsersURL))
            .willReturn(WireMock.okForContentType(APPLICATION_JSON, result)));
  ...
  public void testTransferContent() {
    ...
    JsonObject destinationUser = new JsonObject().add("id", destinationUserID);
    JsonObject ownedBy = new JsonObject().add("owned_by", destinationUser);

    String result = TestUtils.getFixture("BoxFolder/PutTransferFolder200");

    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(transferContentURL))
  ...
  public void testDeserializationException() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(usersURL))
            .willReturn(WireMock.okForContentType(APPLICATION_JSON, result)));
  ...
  public void testCreateReadAddTrackingCodesSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(usersURL))
    ...
    // Mock: Verify change
    String threeTrackingCodesResponse =
        TestUtils.getFixture("BoxUser/GetUserThreeTrackingCodes200");
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(usersURL))
            .withQueryParam("fields", WireMock.equalTo("tracking_codes"))
            .inScenario("Get Tracking Code Scenario")
  ...
  public void uploadAvatarAsFile() {
    ...
    String responseBody =
        "{\"pic_urls\": {\"small\": \"url1\",\"large\": \"url2\",\"preview\": \"url3\"}}";
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo("/2.0/users/12345/avatar"))
  ...
  public void uploadAvatarAsStream() throws IOException {
    ...
    AvatarUploadResponse response =
        user.uploadAvatar(Files.newInputStream(Paths.get(filePath)), fileName);
  ...
  public void deleteAvatar() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo("/2.0/users/12345/avatar"))
            .willReturn(WireMock.noContent()));
