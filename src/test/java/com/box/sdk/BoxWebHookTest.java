...
public class BoxWebHookTest {
  ...
  public void testCreateWebhookSucceedsAndSendsCorrectJson() throws IOException {
    ...
    wireMockRule.stubFor(
        WireMock.post(WireMock.urlPathEqualTo(webhookURL))
    ...
    BoxWebHook.Info webhookInfo =
        BoxWebHook.create(folder, new URL(address), BoxWebHook.Trigger.FILE_LOCKED);
  ...
  public void testGetWebhookSuceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(webhookURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testUpdateWebhookInfoSucceeds() throws IOException {
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathEqualTo(webhookURL))
  ...
  public void testDeleteWebhookSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.delete(WireMock.urlPathEqualTo(webhookURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withStatus(204)
