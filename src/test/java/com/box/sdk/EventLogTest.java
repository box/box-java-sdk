...
public class EventLogTest {
  ...
  private static final BoxJSONResponse EMPTY_RESPONSE =
      new BoxJSONResponse() {
        @Override
  ...
  public void getEnterpriseEvents() {
    ...
    EnterpriseEventsRequest request =
        new EnterpriseEventsRequest()
            .after(after)
            .before(before)
            .limit(limit)
            .position(position)
  ...
  public void getEnterpriseEventsStream() {
    ...
    EnterpriseEventsStreamRequest request =
        new EnterpriseEventsStreamRequest().limit(limit).position(position).types(eventTypes);
  ...
  public void getEnterpriseEventsStreamWithTypesAsString() {
    ...
    EnterpriseEventsStreamRequest request =
        new EnterpriseEventsStreamRequest()
            .limit(limit)
            .position(position)
            .typeNames("LOGIN", "FAILED_LOGIN");
    EventLog.getEnterpriseEventsStream(api, request);
