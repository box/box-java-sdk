...
public class BoxEventTest {
  ...
  public void testIsEventLogUnique() throws ParseException {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(eventURL))
  ...
  public void newBoxEventHandlesUnknownEventType() {
    String eventJSON =
        "{ \"type\": \"event\", \"event_id\": \"f82c3ba03e41f7e8a7608363cc6c0390183c3f83\", "
  ...
  public void newBoxEventShouldParseAllFieldsCorrectly() throws ParseException {
    ...
    assertEquals(
        isPerformedByAdmin, event.getAdditionalDetails().get("is_performed_by_admin").asBoolean());
  ...
  public void newBoxEventShouldParseAccessibleByFieldCorrectlyWhenItIsAGroup() {
    ...
    JsonObject eventJSON =
        new JsonObject()
            ...
            .add(
                "accessible_by",
                new JsonObject().add("type", "group").add("id", groupID).add("name", groupName));
