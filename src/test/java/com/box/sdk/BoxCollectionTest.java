...
public class BoxCollectionTest {
  ...
  public void testGetItemsRequestCorrectFields() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo("/2.0/collections/0/items/"))
            .withQueryParam("fields", WireMock.containing("name"))
            .withQueryParam("fields", WireMock.containing("description"))
            .willReturn(
                WireMock.aResponse().withHeader("Content-Type", APPLICATION_JSON).withBody("{}")));
  ...
  public void addItemToCollectionSucceeds() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlEqualTo(collectionURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
    ...
    wireMockRule.stubFor(
        WireMock.put(WireMock.urlPathMatching(addItemURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
  ...
  public void testGetItemsParsesFieldsCorrectly() {
    ...
    wireMockRule.stubFor(
        WireMock.get(WireMock.urlPathEqualTo(collectionItemsURL))
            .willReturn(
                WireMock.aResponse()
                    .withHeader("Content-Type", APPLICATION_JSON)
                    .withBody(result)));
