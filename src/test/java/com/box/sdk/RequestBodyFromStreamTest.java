...
public class RequestBodyFromStreamTest {
  ...
  public void reportCorrectProgressWhenFileIsEmpty() {
    ...
    RequestBodyFromStream request =
        new RequestBodyFromStream(
            inputStream, MediaType.parse("application/json"), progressListener, 0);
  ...
  public void reportCorrectProgressWhenFileSizeIfLessThanBuffer() {
    ...
    RequestBodyFromStream request =
        new RequestBodyFromStream(
            inputStream, MediaType.parse("application/json"), progressListener, howManyBytes);
