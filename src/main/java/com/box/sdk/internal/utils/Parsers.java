...
public class Parsers {
   ...
   *
   * @param jsonObject metadata json object for metadata field in get
   *     /files?fileds=,etadata.scope.template response
   * @return Map of String as key a value another Map with a String key and Metadata value
   */
  public static Map<String, Map<String, Metadata>> parseAndPopulateMetadataMap(
   ...
   *
   * @param jsonObject representations json object in get response for
   *     /files/file-id?fields=representations
