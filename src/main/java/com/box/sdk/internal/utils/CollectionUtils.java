...
public class CollectionUtils {
   ...
   */
  public static <T_Result, T_Source> List<T_Result> map(
      Collection<T_Source> source, Mapper<T_Result, T_Source> mapper) {
   ...
   * @return List with all items from iterable. Elements are in the same order as iterable is
   *     returning them.
   */
