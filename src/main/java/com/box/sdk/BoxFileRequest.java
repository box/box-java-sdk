...
public class BoxFileRequest extends BoxResource {
  ...
  public static final URLTemplate COPY_FILE_REQUEST_URL_TEMPLATE =
      new URLTemplate("file_requests/%s/copy");
  ...
  /**
   * Copies this file request that is already present on one folder, and applies it to another
   * folder.
   *
  ...
  public BoxFileRequest.Info copyInfo(String folderId) {
    ...
    try (BoxJSONResponse response = request.send()) {
      ...
      return new BoxFileRequest(this.getAPI(), id)
      .new Info(jsonObject, this.getAPI().getBaseAppUrl());
    }
  }
   ...
   * folder.
   *
   * <p>Info fields that have been modified locally will overwrite the values in the original file
   * request.
   *
   * @param info the info.
   * @param folderId the ID of the folder for the file request.
  ...
  /**
   * Updates the information about this file request with any info fields that have been modified
   * locally.
   *
  ...
  public class Info extends BoxResource.Info {
    ...
    /**
     * Gets whether a file request submitter is required to provide a description of the files they
     * are submitting.
     *
     * @return whether a file request submitter is required to provide a description of the files
     *     they are submitting.
     */
    ...
    /**
     * Sets whether a file request submitter is required to provide a description of the files they
     * are submitting.
     *
     * @param isDescriptionRequired whether a file request submitter is required to provide a
     ...
     *
     * @param isEmailRequired whether a file request submitter is required to provide their email
     *     address.
     */
    ...
    /**
     * Sets the base URL for the upload files link. Can throw an exception if format of the URL is
     * invalid.
     *
    ...
    /**
     * Gets the URL containing only the path (e.g. "/f/123456789") shared with users to let them
     * upload files to the associated folder.
     *
