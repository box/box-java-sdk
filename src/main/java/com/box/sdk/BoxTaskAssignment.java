...
/**
 * Represents a task assignment on Box, which can be used to assign a task to a single user. There
 * can be multiple assignments on a single task.
 */
...
public class BoxTaskAssignment extends BoxResource {
  ...
  public static final URLTemplate TASK_ASSIGNMENT_URL_TEMPLATE =
      new URLTemplate("task_assignments/%s");
  ...
  public Info getInfo(String... fields) {
    ...
    URL url =
        TASK_ASSIGNMENT_URL_TEMPLATE.buildWithQuery(
  ...
  /**
   * Updates the information about this task assignment with any info fields that have been modified
   * locally.
   *
    ...
    static ResolutionState fromJSONString(String jsonValue) {
      if (jsonValue.equals("completed")) {
        ...
        throw new IllegalArgumentException(
            "The provided JSON value isn't a valid ResolutionState.");
      }
    }
