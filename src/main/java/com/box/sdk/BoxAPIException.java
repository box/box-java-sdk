...
public class BoxAPIException extends RuntimeException {
  ...
  /**
   * Constructs a BoxAPIException with details about the server's response, including response
   * headers.
   *
   * @param message a message explaining why the exception occurred.
   * @param responseCode the response code returned by the Box server.
  ...
  /**
   * Constructs a BoxAPIException that wraps another underlying exception with details about the
   * server's response.
   *
   * @param message a message explaining why the exception occurred.
   * @param responseCode the response code returned by the Box server.
