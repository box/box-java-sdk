...
public class BoxTermsOfService extends BoxResource {
   ...
   *
   * @param api the API connection to be used by the resource.
   * @param termsOfServiceStatus the current status of the terms of services. Set to "enabled" or
   *     "disabled".
   ...
   */
  public static BoxTermsOfService.Info create(
    ...
    try (BoxJSONResponse response = request.send()) {
      ...
      BoxTermsOfService createdTermsOfServices =
          new BoxTermsOfService(api, responseJSON.get("id").asString());
   ...
   * @param termsOfServiceType the type of terms of service to be retrieved. Can be set to "managed"
   *     or "external"
  ...
  public static List<BoxTermsOfService.Info> getAllTermsOfServices(
      final BoxAPIConnection api, BoxTermsOfService.TermsOfServiceType termsOfServiceType) {
    ...
    URL url =
        ALL_TERMS_OF_SERVICES_URL_TEMPLATE.buildWithQuery(api.getBaseURL(), builder.toString());
    ...
    try (BoxJSONResponse response = request.send()) {
      ...
      for (JsonValue value : entries) {
        ...
        BoxTermsOfService termsOfService =
            new BoxTermsOfService(api, termsOfServiceJSON.get("id").asString());
  ...
  /**
   * Updates the information about this terms of service with modified locally info. Only status and
