...
public class BoxGroupMembership extends BoxResource {
  ...
  /**
   * Updates the information about this group membership with any info fields that have been
   * modified locally.
   *
  ...
  public class Info extends BoxResource.Info {
     ...
     *
     * <p>Note: the BoxUser.Info returned by this method will only have the ID, name, and login
     * fields populated.
     *
     ...
     *
     * <p>Note: the BoxGroup.Info returned by this method will only have the ID and name fields
     * populated.
     *
     ...
     *
     * @param permission the group admin permission one wants to enable or disable of the user on
     *     the group.
    ...
    private JsonObject configurablePermissionJson() {
      ...
      for (Permission attrKey : this.configurablePermissions.keySet()) {
        configurablePermissionJson.set(
            attrKey.toJSONValue(), this.configurablePermissions.get(attrKey));
      }
