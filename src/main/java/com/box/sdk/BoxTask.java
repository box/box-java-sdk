...
public class BoxTask extends BoxResource {
  ...
  public static final URLTemplate GET_ASSIGNMENTS_URL_TEMPLATE =
      new URLTemplate("tasks/%s/assignments");
  /** Add Task Assignment URL Template. */
  public static final URLTemplate ADD_TASK_ASSIGNMENT_URL_TEMPLATE =
      new URLTemplate("task_assignments");
  ...
  public BoxTaskAssignment.Info addAssignment(BoxUser assignTo) {
    ...
    try (BoxJSONResponse response = request.send()) {
      ...
      BoxTaskAssignment addedAssignment =
          new BoxTaskAssignment(this.getAPI(), responseJSON.get("id").asString());
  ...
  public Iterable<BoxTaskAssignment.Info> getAllAssignments(String... fields) {
    ...
    return () -> {
      URL url =
          GET_ASSIGNMENTS_URL_TEMPLATE.buildWithQuery(
  ...
  public Info getInfo(String... fields) {
    ...
    if (fields.length > 0) {
      ...
      url =
          TASK_URL_TEMPLATE.buildWithQuery(
