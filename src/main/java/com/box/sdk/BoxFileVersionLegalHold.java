...
/**
 * Representing all holds on a file version. Note that every file version can have a maximum of one
...
public class BoxFileVersionLegalHold extends BoxResource {
   ...
   * @see #getInfo(String...)
   */
  public static final URLTemplate FILE_VERSION_HOLD_URL_TEMPLATE =
      new URLTemplate("file_version_legal_holds/%s");
  ...
  public BoxFileVersionLegalHold.Info getInfo(String... fields) {
    ...
    URL url =
        FILE_VERSION_HOLD_URL_TEMPLATE.buildWithQuery(
  ...
  public class Info extends BoxResource.Info {
    ...
    /**
     * @return the parent file of the file version that is held. Note that there is no guarantee
     *     that the current version of this file is held.
     */
