 ...
 *
 * <p>This request type extends BoxAPIResponse to provide additional functionality for handling JSON
 * strings. It reads the response body into a string and allows the JSON in the response to be
 * logged.
 */
public class BoxJSONResponse extends BoxAPIResponse {
  ...
  /**
   * Gets the body of the response as a JSON string. When this method is called, the response's body
   * will be read and the response will be disconnected, meaning that the stream returned by {@link
   * #getBody} can no longer be used.
   *
