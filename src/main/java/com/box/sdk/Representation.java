...
public class Representation {
  ...
  /**
   * Get the extension of the format, but occasionally a name of a standard (potentially de facto)
  ...
  /**
   * Get representation's set of static properties to distinguish between subtypes of a given
   * representation, for example, different sizes of jpg's. Each representation has its own set of
   * properties.
   *
  ...
  /**
   * Get Info which has an opaque URL which will return status information about the file. It may
   * change over time and should not be hard-coded or cached.
   *
   * @return info
   */
  public Info getInfo() {
  ...
  /**
   * A string with one of the following values: 'none', 'pending', 'viewable', 'error' and
   * 'success'.
   *
   * @return status
   */
  ...
  public class Content {
    ...
    /**
     * Get an opaque URL template to the content, which follows RFC 6570. There is an asset_path
     * variable that should be replaced with a valid path. Valid paths are different for each
     * representation subtype. It may change over time and should not be hard-coded or cached.
     *
     * @return url template
     */
  ...
  public class Status {
    ...
    /**
     * A string with one of the following values: 'none', 'pending', 'viewable', 'error' and
     * 'success'. none - the unknown or initial state. pending - content is being generated but is
     * not ready yet. viewable - like pending, though indicates that enough content is available to
     * be useful. error - an error happened and this content is not available. success - all of the
     * content is available and complete.
     *
     * @return state
     */
