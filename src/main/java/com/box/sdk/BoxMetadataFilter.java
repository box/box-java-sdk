...
/**
 * BoxMetadataFilter is used to help organize the request for when making metadata filter request in
 * conjuction with search. The translation will look something like this:
 * [{"templateKey":"marketingCollateral", "scope":"enterprise", "filters":{"documentType":
 * "datasheet"}}]
 */
