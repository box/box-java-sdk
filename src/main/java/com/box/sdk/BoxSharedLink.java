...
public class BoxSharedLink extends BoxJSONObject {
  ...
  /**
   * Sets vanity name used to create vanity URL. For example: vanityName = myCustomName will produce
   * vanityUrl as: https://app.box.com/v/myCustomName Custom URLs should not be used when sharing
   * sensitive content as vanity URLs are a lot easier to guess than regular shared links.
   *
   ...
   *     <p>Note there is no setEffectiveAccess metho becaused this cannot be changed via the API
   */
  ...
  public static class Permissions extends BoxJSONObject {
    ...
    /**
     * Sets whether the shared link allows for editing of files. For folders this value will always
     * be set to false.
     *
