...
public class BoxConfig {
  ...
  /**
   * Creates a configuration with clientId, clientSecret, publicKeyID, privateKey,
   * privateKeyPassword. and an encryptionAlgorithm.
   *
   * @param clientId the client ID of the application
   * @param clientSecret the client secret of the application
   * @param enterpriseId the enterprise ID of the box account
   ...
   * @param encryptionAlgorithm the encryption algorithm that has to be used for signing JWT
   *     requests
   */
  public BoxConfig(
      String clientId,
   ...
   *
   * @param privateKeyDecryptor privateKeyDecryptor the decryptor used for decrypting the private
   *     key.
   */
