...
public class BoxDevicePin extends BoxResource {
  ...
  public static final URLTemplate ENTERPRISE_DEVICE_PINS_TEMPLATE =
      new URLTemplate("enterprises/%s/device_pinners");
  ...
  /**
   * Returns iterable with all the device pins within a given enterprise. Must be an enterprise
   ...
   */
  public static Iterable<BoxDevicePin.Info> getEnterpriceDevicePins(
      final BoxAPIConnection api, String enterpriseID, String... fields) {
   ...
   */
  public static Iterable<BoxDevicePin.Info> getEnterpriceDevicePins(
      final BoxAPIConnection api, String enterpriseID, int limit, String... fields) {
    QueryStringBuilder builder = new QueryStringBuilder();
    if (fields.length > 0) {
      builder.appendParam("fields", fields);
    }
    return new BoxResourceIterable<BoxDevicePin.Info>(
        api,
        ENTERPRISE_DEVICE_PINS_TEMPLATE.buildWithQuery(
            api.getBaseURL(), builder.toString(), enterpriseID),
        limit) {
  ...
  public Info getInfo(String... fields) {
    ...
    URL url =
        DEVICE_PIN_URL_TEMPLATE.buildWithQuery(
