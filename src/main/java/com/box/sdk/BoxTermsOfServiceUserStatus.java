...
public class BoxTermsOfServiceUserStatus extends BoxResource {
   ...
   */
  public static BoxTermsOfServiceUserStatus.Info create(
      final BoxAPIConnection api, String termsOfServiceID, Boolean isAccepted) {
   ...
   */
  public static BoxTermsOfServiceUserStatus.Info create(
      final BoxAPIConnection api, String termsOfServiceID, Boolean isAccepted, String userID) {
    URL url = ALL_TERMS_OF_SERVICE_USER_STATUSES_TEMPLATE.build(api.getBaseURL());
    BoxJSONRequest request = new BoxJSONRequest(api, url, "POST");
    JsonObject requestJSON =
        new JsonObject()
            .add(
                "tos", new JsonObject().add("type", "terms_of_service").add("id", termsOfServiceID))
            .add("is_accepted", isAccepted);

    if (userID != null) {
      requestJSON.add("user", new JsonObject().add("type", "user").add("id", userID));
    }
    ...
    try (BoxJSONResponse response = request.send()) {
      ...
      BoxTermsOfServiceUserStatus termsOfServiceUserStatus =
          new BoxTermsOfServiceUserStatus(api, responseJSON.get("id").asString());
   ...
   */
  public static List<BoxTermsOfServiceUserStatus.Info> getInfo(
      final BoxAPIConnection api, String termsOfServiceID) {
   ...
   */
  public static List<BoxTermsOfServiceUserStatus.Info> getInfo(
      final BoxAPIConnection api, String termsOfServiceID, String userID) {
    ...
    URL url =
        ALL_TERMS_OF_SERVICE_USER_STATUSES_TEMPLATE.buildWithQuery(
    ...
    try (BoxJSONResponse response = request.send()) {
      ...
      for (JsonValue value : entries) {
        ...
        BoxTermsOfServiceUserStatus termsOfServiceUserStatus =
            new BoxTermsOfServiceUserStatus(api, termsOfServiceUserStatusJSON.get("id").asString());
        BoxTermsOfServiceUserStatus.Info info =
            termsOfServiceUserStatus.new Info(termsOfServiceUserStatusJSON);
  ...
  /**
   * Updates the information about the user status for this terms of service with any info fields
  ...
  public void updateInfo(BoxTermsOfServiceUserStatus.Info info) {
    URL url =
        TERMS_OF_SERVICE_USER_STATUSES_TEMPLATE.build(this.getAPI().getBaseURL(), this.getID());
