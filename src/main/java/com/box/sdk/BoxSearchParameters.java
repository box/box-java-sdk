 ...
 *
 * <p>Advanced Search support here allows a number of parameters be specified to take full advantage
 * of box search capabilities. Query parameter is required in all cases except when Metadata
 * templates searching is being used.
 */
public class BoxSearchParameters {
  ...
  /**
   * Set trash filter. Can be trashed_only or non_trashed_only, without this parameter default to
   * non_trashed_only.
   *
   ...
   * list of comma separated user IDs. The trash_content parameter needs to be set to trashed_only.
   *
  ...
  /**
   * Limits the search results to items that were deleted within the given date range. The
   * trash_content parameter needs to be set to trashed_only.
   *
   * @return deletedRange.
   */
