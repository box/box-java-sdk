...
/**
 * Represents a file version retention. A retention policy blocks permanent deletion of content for
 * a specified amount of time. Admins can apply policies to specified folders, or an entire
 * enterprise. A file version retention is a record for a retained file version.
 *
 * @see <a href="https://developer.box.com/reference/resources/file-version-retention/">Box file
 *     version retention</a>
...
public class BoxFileVersionRetention extends BoxResource {
  ...
  public static final URLTemplate RETENTION_URL_TEMPLATE =
      new URLTemplate("file_version_retentions/%s");
  ...
  public static final URLTemplate ALL_RETENTIONS_URL_TEMPLATE =
      new URLTemplate("file_version_retentions");
   ...
   */
  public static Iterable<BoxFileVersionRetention.Info> getAll(
   ...
   * @param fields the fields to retrieve.
   * @return an iterable contains information about all file version retentions matching given
   *     filter.
   */
  public static Iterable<BoxFileVersionRetention.Info> getRetentions(
    ...
    return new BoxResourceIterable<BoxFileVersionRetention.Info>(
        api,
      ...
      protected BoxFileVersionRetention.Info factory(JsonObject jsonObject) {
        BoxFileVersionRetention retention =
            new BoxFileVersionRetention(api, jsonObject.get("id").asString());
  ...
  public BoxFileVersionRetention.Info getInfo(String... fields) {
    ...
    URL url =
        RETENTION_URL_TEMPLATE.buildWithQuery(
