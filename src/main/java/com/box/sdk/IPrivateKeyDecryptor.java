...
/**
 * Implement this interface to provide a custom private key decryptor. If you require the decryption
 * operation to be FIPS compliant, ensure that your implementation exclusively utilizes FIPS
 * certified libraries.
 */
