 ...
 * contains image binary data. Image type will be determined from the file name.
 *
...
class BoxImageMultipartRequest extends AbstractBoxMultipartRequest {
    ...
    /**
     * Constructs an authenticated BoxImageMultipartRequest using a provided BoxAPIConnection.
     * You can define part name that contains image binary data. Image type will be determined from the file name.
     *
