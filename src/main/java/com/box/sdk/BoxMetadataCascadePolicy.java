...
public class BoxMetadataCascadePolicy extends BoxResource {
   ...
   */
  public static Iterable<BoxMetadataCascadePolicy.Info> getAll(
      final BoxAPIConnection api, String folderID, String... fields) {
  ...
  public static Iterable<BoxMetadataCascadePolicy.Info> getAll(
    ...
    return new BoxResourceIterable<Info>(
        api,
        GET_ALL_METADATA_CASCADE_POLICIES_URL_TEMPLATE.buildWithQuery(
   ...
   */
  public static BoxMetadataCascadePolicy.Info create(
      final BoxAPIConnection api, String folderID, String scope, String templateKey) {
  ...
  public BoxMetadataCascadePolicy.Info getInfo(String... fields) {
    ...
    URL url =
        METADATA_CASCADE_POLICIES_URL_TEMPLATE.buildAlphaWithQuery(
   ...
   *
   * @param conflictResolution the desired behavior for conflict-resolution. Set to either none or
   *     overwrite.
   */
  public void forceApply(String conflictResolution) {

    URL url =
        FORCE_METADATA_CASCADE_POLICIES_URL_TEMPLATE.buildAlpha(
  ...
  public void delete() {
    URL url =
        METADATA_CASCADE_POLICIES_URL_TEMPLATE.buildAlpha(this.getAPI().getBaseURL(), this.getID());
