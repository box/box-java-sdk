...
public class BoxTrash implements Iterable<BoxItem.Info> {
  ...
  public BoxFolder.Info restoreFolder(String folderID) {
    ...
    JsonObject requestJSON = new JsonObject().add("", "");
   ...
   *
   * @param folderID the ID of the trashed folder.
   * @param newName an optional new name to give the folder. This can be null to use the folder's
   *     original name.
   * @param newParentID an optional new parent ID for the folder. This can be null to use the
   *     folder's original parent.
   * @return info about the restored folder.
   */
   ...
   *
   * @param fileID the ID of the trashed file.
   * @param newName an optional new name to give the file. This can be null to use the file's
   *     original name.
   * @param newParentID an optional new parent ID for the file. This can be null to use the file's
   *     original parent.
   * @return info about the restored file.
   */
  ...
  /**
   * Returns an iterable containing the items in trash. You can specify sort order, limit of files
   * requested, ofset or use marker based pagination.
   *
  ...
  public Iterable<BoxItem.Info> items(
      SortParameters sortParameters, PagingParameters pagingParameters, String... fields) {
