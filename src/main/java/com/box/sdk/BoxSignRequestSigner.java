...
public class BoxSignRequestSigner extends BoxJSONObject {
  ...
  /**
   * Gets the flag that when used in combination with an embed url on the sender. After the sender
   * signs, they will be redirected to the next InPerson signer.
   *
  ...
  /**
   * Gets the user id for this signer in external application responsible for authentication when
   * accessing the embed url.
   *
  ...
  /**
   * Sets the user id for this signer in external application responsible for authentication when
   * accessing the embed url.
   *
   * @param embedUrlExternalUserId for this signer in external application responsible for
  ...
  /**
   * Gets the flag that is used in combination with an embed url for a the sender. After the sender
   * signs, they will be redirected to the next InPerson signer.
   *
   * @return true if is in person signer, otherwise false.
   */
  ...
  /**
   * Sets the flag that is used in combination with an embed url for a the sender. After the sender
   * signs, they will be redirected to the next InPerson signer.
   *
  ...
  /**
   * Gets the URL designed for signing documents within an HTML iframe tag. It will be returned in
   * the response only if the embedUrlExternalUserId parameter was passed in the create sign request
   * call.
   *
  ...
  /**
   * Sets the URL designed for signing documents within an HTML iframe tag. It will be returned in
   * the response only if the embedUrlExternalUserId parameter was passed in the create sign request
   * call.
   *
  ...
  /**
   * Sets the group id. If specified, signers sharing the same group ID will be assigned to the same
   * input. The group ID can be any string value, but it must be consistent across all signers. It
   * is sufficient for only one signer from the group to sign the document.
   *
  ...
  /**
   * If set to true, signer will need to login to a Box account before signing the request. If the
   * signer does not have an existing account, they will have an option to create a free Box
   * account.
   *
  ...
  /**
   * Gets the phone number used for verification. If set, this phone number is be used to verify the
   * signer via two factor authentication before they are able to sign the document.
   *
  ...
  /**
   * Sets the phone number used for verification. If set, this phone number is be used to verify the
   * signer via two factor authentication before they are able to sign the document.
   *
  ...
  public enum BoxSignRequestInputType {
    ...
    static BoxSignRequestInputType fromJSONString(String jsonValue) {
      ...
      throw new IllegalArgumentException(
          "The provided JSON value isn't a valid " + "BoxSignRequestInputType.");
    }
  }
    ...
    static BoxSignRequestInputContentType fromJSONString(String jsonValue) {
      switch (jsonValue) {
        ...
        default:
          throw new IllegalArgumentException(
              format(
                  "The provided JSON value '%s' isn't a valid BoxSignRequestInputContentType.",
                  jsonValue));
      }
    }
  }
  ...
  public class BoxSignerInput extends BoxJSONObject {
    ...
    /**
     * Gets the reference of the id of a particular tag added to the content of the files being used
     * to create the sign request.
     *
