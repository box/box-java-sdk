...
/**
 * Represents a watermark. Watermarks are used to protect sensitive information in the Box account.
 *
  ...
  void parseJSONMember(JsonObject.Member member) {
    ...
    if (memberName.equals(WATERMARK_JSON_KEY)) {
      try {
        ...
        this.modifiedAt =
            BoxDateFormat.parse(value.asObject().get(MODIFIED_AT_JSON_KEY).asString());
      } catch (Exception e) {
