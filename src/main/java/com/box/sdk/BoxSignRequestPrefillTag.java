...
/**
 * Represents a prefill tag used in BoxSignRequest. When a document contains sign related tags in
 * the content, you can prefill them using this prefillTag by referencing the 'id' of the tag as the
 * externalId field of the prefill tag.
 */
public class BoxSignRequestPrefillTag extends BoxJSONObject {
  ...
  /**
   * Gets the reference id of a particular tag added to the content of the files being used to
