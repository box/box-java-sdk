...
public class FileUploadParams {
  ...
  /**
   * Gets the size of the file's content used for monitoring the upload's progress. If the size
   * cannot be determined value will be -1.
   *
  ...
  /**
   * Sets the size of the file content used for monitoring the upload's progress. When the content
   * is coming from a dynamic source - other thread reading value set size to -1 to tell SDK that
   * file size cannot be determined. Usefull when encuntering problems with writing different size
   * of bytes than assumed.
   *
