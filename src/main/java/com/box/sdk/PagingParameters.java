...
/**
 * Abstraction on how SDK is doing pagination. Can be used to start offset or marker based
 * pagination.
 */
public final class PagingParameters {
  ...
  QueryStringBuilder asQueryStringBuilder() {
    QueryStringBuilder result = new QueryStringBuilder().appendParam("limit", limit);
    if (useMarker) {
