...
/**
 * Represents an entry of the history of prompts and answers previously passed to the LLM. This
...
public class BoxAIDialogueEntry extends BoxJSONObject {
   ...
   * @param createdAt The ISO date formatted timestamp of when the previous answer to the prompt was
   *     created.
   */
  ...
  public JsonObject getJSONObject() {
    JsonObject itemJSON = new JsonObject().add("prompt", this.prompt).add("answer", this.answer);
