 ...
 *
 * @see <a href="https://developer.box.com/reference/resources/sign-templates/">Box Sign
 *     Templates</a>
...
public class BoxSignTemplate extends BoxResource {
  ...
  public class Info extends BoxResource.Info {
    ...
    /**
     * Gets whether the templates input fields are editable or not. This includes deleting or
    ...
    /**
     * Gets whether the template document options are editable or not, for example renaming the
     * document.
     *
    ...
    /**
     * Gets the number of days after which the created signature request will automatically expire
     * if not completed. By default, we do not apply any expiration date on signature requests, and
     * the signature request does not expire.
     *
    ...
    private BoxSignTemplateCustomBranding parseCustomBranding(JsonObject customBrandingJSON) {
      ...
      return new BoxSignTemplateCustomBranding(
          brandingColor, companyName, emailFooterText, logoUri);
    }
    ...
    private BoxSignTemplateReadySignLink parseReadySignLink(JsonObject readySignLinkJSON) {
      ...
      boolean isNofiticationDisabled =
          readySignLinkJSON.get("is_notification_disabled").asBoolean();
      String name = readySignLinkJSON.get("name").asString();
      String url = readySignLinkJSON.get("url").asString();
      return new BoxSignTemplateReadySignLink(
          folderID, instructions, isActive, isNofiticationDisabled, name, url);
    }
  }
}
