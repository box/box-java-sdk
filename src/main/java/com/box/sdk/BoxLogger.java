...
public final class BoxLogger {
  ...
  /**
   * Specify whether this logger should send its output to its parent Logger. This means that any
   * LogRecords will also be written to the parent's Handlers, and potentially to its parent,
  ...
  /**
   * Adds handler to logger. Check {@link Logger#addHandler(Handler)}
   *
  ...
  /**
   * Removes handler from logger. Will not fail if handler is null or not registered. Check {@link
