...
public class GetHubDocumentPagesV2025R0Headers {
  ...
  public GetHubDocumentPagesV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected GetHubDocumentPagesV2025R0Headers(Builder builder) {
  ...
  public static class Builder {
    ...
    public GetHubDocumentPagesV2025R0Headers build() {
      ...
      return new GetHubDocumentPagesV2025R0Headers(this);
    }
  }
}
