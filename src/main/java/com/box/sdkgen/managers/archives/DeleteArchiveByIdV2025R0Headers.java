...
public class DeleteArchiveByIdV2025R0Headers {
  ...
  public DeleteArchiveByIdV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected DeleteArchiveByIdV2025R0Headers(Builder builder) {
  ...
  public static class Builder {
    ...
    public DeleteArchiveByIdV2025R0Headers build() {
      return new DeleteArchiveByIdV2025R0Headers(this);
    }
  }
}
