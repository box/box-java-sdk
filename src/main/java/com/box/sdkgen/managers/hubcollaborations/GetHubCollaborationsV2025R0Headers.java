...
public class GetHubCollaborationsV2025R0Headers {
  ...
  public GetHubCollaborationsV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected GetHubCollaborationsV2025R0Headers(Builder builder) {
  ...
  public static class Builder {
    ...
    public GetHubCollaborationsV2025R0Headers build() {
      return new GetHubCollaborationsV2025R0Headers(this);
    }
  }
}
