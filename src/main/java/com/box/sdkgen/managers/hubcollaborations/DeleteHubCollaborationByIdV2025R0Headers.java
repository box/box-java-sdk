...
public class DeleteHubCollaborationByIdV2025R0Headers {
  ...
  public DeleteHubCollaborationByIdV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected DeleteHubCollaborationByIdV2025R0Headers(Builder builder) {
  ...
  public static class Builder {
    ...
    public DeleteHubCollaborationByIdV2025R0Headers build() {
      ...
      return new DeleteHubCollaborationByIdV2025R0Headers(this);
    }
  }
}
