...
public class GetHubCollaborationByIdV2025R0Headers {
  ...
  public GetHubCollaborationByIdV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected GetHubCollaborationByIdV2025R0Headers(Builder builder) {
  ...
  public static class Builder {
    ...
    public GetHubCollaborationByIdV2025R0Headers build() {
      return new GetHubCollaborationByIdV2025R0Headers(this);
    }
  }
}
