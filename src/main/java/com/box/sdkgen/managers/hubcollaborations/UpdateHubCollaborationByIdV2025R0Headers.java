...
public class UpdateHubCollaborationByIdV2025R0Headers {
  ...
  public UpdateHubCollaborationByIdV2025R0Headers() {
    this.boxVersion = new EnumWrapper<BoxVersionHeaderV2025R0>(BoxVersionHeaderV2025R0._2025_0);
    this.extraHeaders = mapOf();
  }

  protected UpdateHubCollaborationByIdV2025R0Headers(Builder builder) {
  ...
  public static class Builder {
    ...
    public UpdateHubCollaborationByIdV2025R0Headers build() {
      ...
      return new UpdateHubCollaborationByIdV2025R0Headers(this);
    }
  }
}
