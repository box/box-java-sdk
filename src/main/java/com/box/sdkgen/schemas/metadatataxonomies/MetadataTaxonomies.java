package com.box.sdkgen.schemas.metadatataxonomies;
...
public class MetadataTaxonomies extends SerializableObject {
  ...
  /** A list of metadata taxonomies. */
  protected List<MetadataTaxonomy> entries;

  public MetadataTaxonomies() {
    super();
  }

  protected MetadataTaxonomies(Builder builder) {
    super();
  ...
  public List<MetadataTaxonomy> getEntries() {
    return entries;
  }
  ...
  public boolean equals(Object o) {
    ...
    MetadataTaxonomies casted = (MetadataTaxonomies) o;
  ...
  public static class Builder extends NullableFieldTracker {
    ...
    public MetadataTaxonomies build() {
      return new MetadataTaxonomies(this);
    }
  }
}
