package com.box.sdkgen.schemas.metadatataxonomynodes;
...
public class MetadataTaxonomyNodes extends SerializableObject {
  ...
  /** A list of metadata taxonomy nodes. */
  protected List<MetadataTaxonomyNode> entries;

  public MetadataTaxonomyNodes() {
    super();
  }

  protected MetadataTaxonomyNodes(Builder builder) {
    super();
  ...
  public List<MetadataTaxonomyNode> getEntries() {
    return entries;
  }
  ...
  public boolean equals(Object o) {
    ...
    MetadataTaxonomyNodes casted = (MetadataTaxonomyNodes) o;
