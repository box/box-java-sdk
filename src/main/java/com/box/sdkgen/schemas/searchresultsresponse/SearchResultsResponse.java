package com.box.sdkgen.schemas.searchresultsresponse;
...
@JsonDeserialize(using = SearchResultsResponse.SearchResultsResponseDeserializer.class)
@JsonSerialize(using = OneOfTwo.OneOfTwoSerializer.class)
public class SearchResultsResponse extends OneOfTwo<SearchResults, SearchResultsWithSharedLinks> {
  ...
  public SearchResultsResponse(SearchResultsWithSharedLinks searchResultsWithSharedLinks) {
  ...
  static class SearchResultsResponseDeserializer extends JsonDeserializer<SearchResultsResponse> {

    public SearchResultsResponseDeserializer() {
      super();
    }

    @Override
    public SearchResultsResponse deserialize(JsonParser jp, DeserializationContext ctxt)
        throws IOException {
      ...
      if (!(discriminant0 == null)) {
        switch (discriminant0.asText()) {
          case "search_results_items":
            return new SearchResultsResponse(JsonManager.deserialize(node, SearchResults.class));
      ...
      throw new JsonMappingException(jp, "Unable to deserialize SearchResultsResponse");
    }
  }
}
