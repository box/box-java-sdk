package com.box.sdkgen.schemas.v2025r0.filereferenceorfolderreferenceorweblinkreferencev2025r0;
...
@JsonDeserialize(
    using =
        FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0
            .FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0Deserializer.class)
...
public class FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0
  ...
  public FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0(
      FileReferenceV2025R0 fileReferenceV2025R0) {
  ...
  public FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0(
      FolderReferenceV2025R0 folderReferenceV2025R0) {
  ...
  public FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0(
      WeblinkReferenceV2025R0 weblinkReferenceV2025R0) {
  ...
  static class FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0Deserializer
      extends JsonDeserializer<FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0> {

    public FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0Deserializer() {
      super();
    }

    @Override
    public FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0 deserialize(
      ...
      if (!(discriminant0 == null)) {
        switch (discriminant0.asText()) {
          case "file":
            return new FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0(
      ...
      throw new JsonMappingException(
          jp, "Unable to deserialize FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0");
    }
  }
}
