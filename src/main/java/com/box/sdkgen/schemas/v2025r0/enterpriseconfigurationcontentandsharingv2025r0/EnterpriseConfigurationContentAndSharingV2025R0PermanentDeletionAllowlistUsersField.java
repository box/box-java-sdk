...
public class EnterpriseConfigurationContentAndSharingV2025R0PermanentDeletionAllowlistUsersField
  ...
  public boolean equals(Object o) {
    ...
    EnterpriseConfigurationContentAndSharingV2025R0PermanentDeletionAllowlistUsersField casted =
        (EnterpriseConfigurationContentAndSharingV2025R0PermanentDeletionAllowlistUsersField) o;
  ...
  public String toString() {
    return "EnterpriseConfigurationContentAndSharingV2025R0PermanentDeletionAllowlistUsersField{"
        + "isUsed='"
        + isUsed
        + '\''
        + ", "
  ...
  public static class Builder extends EnterpriseConfigurationItemV2025R0.Builder {
    ...
    public EnterpriseConfigurationContentAndSharingV2025R0PermanentDeletionAllowlistUsersField
        build() {
      return new EnterpriseConfigurationContentAndSharingV2025R0PermanentDeletionAllowlistUsersField(
          this);
    }
  }
}
