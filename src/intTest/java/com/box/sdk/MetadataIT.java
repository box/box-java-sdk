...
public class MetadataIT {
  ...
  public void testMetadataPrecisionDouble() {
    ...
    MetadataTemplate template =
        MetadataTemplate.createMetadataTemplate(
            api, "enterprise", templateKey, "Precision " + timestamp, false, fields);
    try {
  ...
  public void testMultiSelectMetadataCRUD() {
    ...
    try {
      ...
      template =
          MetadataTemplate.createMetadataTemplate(
              api, "enterprise", templateKey, "MultiSelect " + timestamp, false, fields);
      ...
      // Update template with multiselect operations - change existing field and add another
      // multiselect field
