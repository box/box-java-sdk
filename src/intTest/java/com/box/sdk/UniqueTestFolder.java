...
public final class UniqueTestFolder {
  ...
  /**
   * Used to upload sample files to specific folder. Sample files are located in
   * src/test/resources/sample-files
   *
   * @param api Api used to upload the file.
   ...
   * @return BoxFile Returns uploaded BoxFile.
   */
  public static BoxFile uploadSampleFileToFolder(
      BoxAPIConnection api, String fileName, String folderId) {
  ...
  public static BoxFile uploadFileToUniqueFolder(
      BoxAPIConnection api, String fileName, String fileContent) {
    return uploadFileWithContentToSpecifiedFolder(fileName, fileContent, getUniqueFolder(api));
  }

  public static BoxFile uploadFileToUniqueFolderWithSomeContent(
      BoxAPIConnection api, String fileName) {
