...
public class BoxTransactionalAPIConnectionIT {
  ...
  public void successfullyCreatesTransactionalConnection() {
    ...
    BoxAPIConnection transactionConnection =
        BoxTransactionalAPIConnection.getTransactionConnection(
            transactionalAccessToken, "item_preview");
  ...
  public void
      throwsWhenAttemptingToCreatesEmbedLinkWithAnotherFilesResourceScopedTransactionalConnection() {
    final String transactionalAccessToken = TestConfig.getTransactionalAccessToken();
