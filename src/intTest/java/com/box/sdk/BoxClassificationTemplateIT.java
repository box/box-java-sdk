...
public class BoxClassificationTemplateIT {
  ...
  public MetadataTemplate getOrCreateClassificationTemplate(BoxAPIConnection api) {
    ...
    return MetadataTemplate.createMetadataTemplate(
        api,
  ...
  public void getUpdateClassificationTemplate() {
    ...
    List<MetadataTemplate.FieldOperation> updates =
        new ArrayList<MetadataTemplate.FieldOperation>();
    String update =
        "{\n"
            + "  \"op\": \"editEnumOption\",\n"
            + "  \"fieldKey\": \""
    ...
    assertEquals(
        updatedOption
            .getStaticConfig()
            .getClassification()
            .getString("classificationDefinition", "null"),
        "Sensitive information.");
    assertEquals(updatedOption.getStaticConfig().getClassification().getInt("colorID", 0), 4);
    update =
        "{\n"
            + "  \"op\": \"editEnumOption\",\n"
            + "  \"fieldKey\": \""
