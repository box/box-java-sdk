...
public class BoxWebLinkIT {
  ...
  public void copyWebLinkSucceeds() throws MalformedURLException {
    ...
    BoxWebLink uploadedWebLink =
        rootFolder.createWebLink(originalFileName, url, description).getResource();
  ...
  public void updateLinkWithSpecialCharsInNameSucceeds() throws MalformedURLException {
    ...
    BoxWebLink.Info uploadedWebLinkInfo =
        rootFolder.createWebLink(originalFileName, url, description);
  ...
  public void setsVanityNameOnASharedLink() throws MalformedURLException {
    ...
    try {
      ...
      BoxSharedLinkWithoutPermissionsRequest request =
