...
for his pull request! 
- Added an additional check to ensure that the [request properties on the request object is not null before sending out the request](https://github.com/box/box-java-sdk/pull/595)
