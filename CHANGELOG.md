...
- Added support to [test update](https://github.com/box/box-java-sdk/blob/master/src/main/java/com/box/sdk/Metadata.java#L235) for multiselect field on metadata
